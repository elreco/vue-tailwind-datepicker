import { cloneVNode as Zt, h as me, Fragment as we, inject as _e, provide as ne, ref as J, onMounted as tt, watchEffect as je, computed as le, defineComponent as ue, onUnmounted as Qe, Teleport as qt, reactive as vt, shallowRef as Jt, openBlock as z, createElementBlock as Z, createElementVNode as A, withDirectives as pe, vShow as ve, toDisplayString as ae, renderList as We, withModifiers as Me, unref as se, createCommentVNode as ye, createVNode as ee, TransitionGroup as Xt, withCtx as Fe, normalizeClass as Te, Transition as mt, nextTick as Ie, watch as Qt, isProxy as er, createBlock as He, renderSlot as it, mergeProps as tr, vModelText as rr } from "vue";
function Oe(t, o, ...a) {
  if (t in o) {
    let s = o[t];
...
function Pe({ visible: t = !0, features: o = 0, ourProps: a, theirProps: e, ...s }) {
  var n;
...
var Se = ((t) => (t[t.First = 1] = "First", t[t.Previous = 2] = "Previous", t[t.Next = 4] = "Next", t[t.Last = 8] = "Last", t[t.WrapAround = 16] = "WrapAround", t[t.NoScroll = 32] = "NoScroll", t))(Se || {}), et = ((t) => (t[t.Error = 0] = "Error", t[t.Overflow = 1] = "Overflow", t[t.Success = 2] = "Success", t[t.Underflow = 3] = "Underflow", t))(et || {}), pr = ((t) => (t[t.Previous = -1] = "Previous", t[t.Next = 1] = "Next", t))(pr || {});
...
function xt(t, o = 0) {
  var a;
  return t === ((a = Ae(t)) == null ? void 0 : a.body) ? !1 : Oe(o, { 0() {
    return t.matches(st);
  }, 1() {
    let e = t;
    for (; e !== null; ) {
...
let ze = ue({ name: "Hidden", props: { as: { type: [Object, String], default: "div" }, features: { type: Number, default: 1 } }, setup(t, { slots: o, attrs: a }) {
  return () => {
    ...
    return Pe({ ourProps: n, theirProps: s, slot: {}, attrs: a, slots: o, name: "Hidden" });
  };
} });
...
ue({ name: "ForcePortalRoot", props: { as: { type: [Object, String], default: "template" }, force: { type: Boolean, default: !1 } }, setup(t, { slots: o, attrs: a }) {
  return ne($t, t.force), () => {
    let { force: e, ...s } = t;
    return Pe({ theirProps: s, ourProps: {}, slot: {}, slots: o, attrs: a, name: "ForcePortalRoot" });
  };
} });
function wr(t) {
  let o = Ae(t);
...
ue({ name: "Portal", props: { as: { type: [Object, String], default: "div" } }, setup(t, { slots: o, attrs: a }) {
  let e = J(null), s = le(() => Ae(e)), n = xr(), h = _e(jt, null), l = J(n === !0 || h == null ? wr(e.value) : h.resolveTarget());
  je(() => {
  ...
  return tt(() => {
    ...
    return me(qt, { to: l.value }, Pe({ ourProps: p, theirProps: t, slot: {}, attrs: a, slots: o, name: "Portal" }));
  };
} });
let lt = Symbol("PortalParentContext");
function kr() {
  let t = _e(lt, null), o = J([]);
  function a(n) {
...
let Ot = ue({ name: "Popover", inheritAttrs: !1, props: { as: { type: [Object, String], default: "div" } }, setup(t, { slots: o, attrs: a, expose: e }) {
  ...
  let n = J(null);
  e({ el: n, $el: n });
  let h = J(1), l = J(null), m = J(null), p = J(null), w = J(null), g = le(() => Ae(n)), O = le(() => {
    var L, i;
    if (!H(l) || !H(w))
      return !1;
  ...
  ne(Mt, V), ur(le(() => Oe(h.value, { 0: Le.Open, 1: Le.Closed })));
  ...
  return je(() => P == null ? void 0 : P(B)), gr((s = g.value) == null ? void 0 : s.defaultView, "focus", (L) => {
    ...
    return me(we, [me(S, {}, () => Pe({ theirProps: { ...t, ...a }, ourProps: { ref: n }, slot: L, slots: o, attrs: a, name: "Popover" })), me(y.MainTreeNode)]);
  };
  ...
  function B(y) {
    p.value || y.key === Ve.Space && y.preventDefault();
  }
  function x(y) {
    var N, L;
  ...
  function S() {
    ...
    if (!y)
      return;
    function N() {
      Oe(k.value, { [De.Forwards]: () => Ee(y, Se.First), [De.Backwards]: () => Ee(y, Se.Last) }) === et.Error && Ee(ot().filter((L) => L.dataset.headlessuiFocusGuard !== "true"), Oe(k.value, { [De.Forwards]: Se.Next, [De.Backwards]: Se.Previous }), { relativeTo: H(s.button) });
    }
    N();
  }
  return () => {
    ...
    return me(we, [Pe({ ourProps: r, theirProps: { ...o, ...i }, slot: N, attrs: o, slots: a, name: "PopoverButton" }), y && !p.value && s.isPortalled.value && me(ze, { id: g, features: Ne.Focusable, "data-headlessui-focus-guard": !0, as: "button", type: "button", onFocus: S })]);
  };
  ...
  return () => {
    ...
    return Pe({ ourProps: { id: s, "aria-hidden": !0, onClick: l }, theirProps: t, slot: m, attrs: o, slots: a, features: Ue.RenderStrategy | Ue.Static, visible: h.value, name: "PopoverOverlay" });
  };
  ...
  let { focus: s } = t, n = at("PopoverPanel"), h = le(() => Ae(n.panel)), l = `headlessui-focus-sentinel-before-${Be()}`, m = `headlessui-focus-sentinel-after-${Be()}`;
  e({ el: n.panel, $el: n.panel }), tt(() => {
    ...
    (k = H(n.panel)) != null && k.contains(S) || Ee(H(n.panel), Se.First);
  });
  ...
  function B() {
    ...
    if (!P)
      return;
    function k() {
      Oe(V.value, { [De.Forwards]: () => {
        var S;
        Ee(P, Se.First) === et.Error && ((S = H(n.afterPanelSentinel)) == null || S.focus());
      }, [De.Backwards]: () => {
        var S;
  ...
  function x() {
    ...
    function k() {
      Oe(V.value, { [De.Forwards]: () => {
        ...
        Ee(r, Se.First, { sorted: !1 });
      }, [De.Backwards]: () => {
        var S;
        Ee(P, Se.Previous) === et.Error && ((S = H(n.button)) == null || S.focus());
      } });
    }
    k();
  }
  return () => {
    ...
    return Pe({ ourProps: N, theirProps: { ...o, ...y }, attrs: o, slot: P, slots: { ...a, default: (...L) => {
      var i;
...
ue({ name: "PopoverGroup", inheritAttrs: !1, props: { as: { type: [Object, String], default: "div" } }, setup(t, { attrs: o, slots: a, expose: e }) {
  let s = J(null), n = Jt([]), h = le(() => Ae(s)), l = jr();
  e({ el: s, $el: s });
  function m(O) {
  ...
  return ne(St, { registerPopover: p, unregisterPopover: m, isFocusWithinPopoverGroup: w, closeOthers: g, mainTreeNodeRef: l.mainTreeNodeRef }), () => me(we, [Pe({ ourProps: { ref: s }, theirProps: { ...t, ...o }, slot: {}, attrs: o, slots: a, name: "PopoverGroup" }), me(l.MainTreeNode)]);
} });
...
const ft = Object.fromEntries(
  Object.entries(/* @__PURE__ */ Object.assign({ "./locale/af.js": () => import("./af-6b6271db.js"), "./locale/am.js": () => import("./am-21131246.js"), "./locale/ar-dz.js": () => import("./ar-dz-5db1c52e.js"), "./locale/ar-iq.js": () => import("./ar-iq-e339108a.js"), "./locale/ar-kw.js": () => import("./ar-kw-2a832460.js"), "./locale/ar-ly.js": () => import("./ar-ly-59de96d6.js"), "./locale/ar-ma.js": () => import("./ar-ma-5898bc6a.js"), "./locale/ar-sa.js": () => import("./ar-sa-a7bdc97b.js"), "./locale/ar-tn.js": () => import("./ar-tn-578c3448.js"), "./locale/ar.js": () => import("./ar-cb1728e4.js"), "./locale/az.js": () => import("./az-00e99dc1.js"), "./locale/be.js": () => import("./be-553babe7.js"), "./locale/bg.js": () => import("./bg-190d935d.js"), "./locale/bi.js": () => import("./bi-a9d531e3.js"), "./locale/bm.js": () => import("./bm-62e09a16.js"), "./locale/bn-bd.js": () => import("./bn-bd-7d3fcaf1.js"), "./locale/bn.js": () => import("./bn-144d6783.js"), "./locale/bo.js": () => import("./bo-ce3ed4ae.js"), "./locale/br.js": () => import("./br-d087d643.js"), "./locale/bs.js": () => import("./bs-53629e13.js"), "./locale/ca.js": () => import("./ca-a79ffcfe.js"), "./locale/cs.js": () => import("./cs-24f129c1.js"), "./locale/cv.js": () => import("./cv-3e5838f9.js"), "./locale/cy.js": () => import("./cy-53f2e288.js"), "./locale/da.js": () => import("./da-a883acb3.js"), "./locale/de-at.js": () => import("./de-at-83bd7580.js"), "./locale/de-ch.js": () => import("./de-ch-1f6b6809.js"), "./locale/de.js": () => import("./de-8e742e1a.js"), "./locale/dv.js": () => import("./dv-497ace88.js"), "./locale/el.js": () => import("./el-34a14351.js"), "./locale/en-au.js": () => import("./en-au-35e3062d.js"), "./locale/en-ca.js": () => import("./en-ca-4c6ae1af.js"), "./locale/en-gb.js": () => import("./en-gb-196ec5fe.js"), "./locale/en-ie.js": () => import("./en-ie-72ce02a2.js"), "./locale/en-il.js": () => import("./en-il-e60fd8c7.js"), "./locale/en-in.js": () => import("./en-in-c71081f0.js"), "./locale/en-nz.js": () => import("./en-nz-e004a9da.js"), "./locale/en-sg.js": () => import("./en-sg-a2e3f675.js"), "./locale/en-tt.js": () => import("./en-tt-94783818.js"), "./locale/en.js": () => import("./en-4402d6fc.js"), "./locale/eo.js": () => import("./eo-3c707c00.js"), "./locale/es-do.js": () => import("./es-do-371ac7a6.js"), "./locale/es-mx.js": () => import("./es-mx-f4ed3a14.js"), "./locale/es-pr.js": () => import("./es-pr-594d76dc.js"), "./locale/es-us.js": () => import("./es-us-c0d977ab.js"), "./locale/es.js": () => import("./es-36b82bd8.js"), "./locale/et.js": () => import("./et-95d8ef54.js"), "./locale/eu.js": () => import("./eu-ff5968a6.js"), "./locale/fa.js": () => import("./fa-e3cf6d8e.js"), "./locale/fi.js": () => import("./fi-4cdb512f.js"), "./locale/fo.js": () => import("./fo-67e758da.js"), "./locale/fr-ca.js": () => import("./fr-ca-9717e4f8.js"), "./locale/fr-ch.js": () => import("./fr-ch-5d8bb260.js"), "./locale/fr.js": () => import("./fr-e64a8b4e.js"), "./locale/fy.js": () => import("./fy-74e13254.js"), "./locale/ga.js": () => import("./ga-61421593.js"), "./locale/gd.js": () => import("./gd-6f276fbe.js"), "./locale/gl.js": () => import("./gl-87da183f.js"), "./locale/gom-latn.js": () => import("./gom-latn-74b70649.js"), "./locale/gu.js": () => import("./gu-bc281334.js"), "./locale/he.js": () => import("./he-a0990c39.js"), "./locale/hi.js": () => import("./hi-eab45aba.js"), "./locale/hr.js": () => import("./hr-844a4a5f.js"), "./locale/ht.js": () => import("./ht-36a19a21.js"), "./locale/hu.js": () => import("./hu-8a91ecfc.js"), "./locale/hy-am.js": () => import("./hy-am-6474e25c.js"), "./locale/id.js": () => import("./id-384ed252.js"), "./locale/is.js": () => import("./is-137cf81e.js"), "./locale/it-ch.js": () => import("./it-ch-14a17c67.js"), "./locale/it.js": () => import("./it-c546de5a.js"), "./locale/ja.js": () => import("./ja-15457e3e.js"), "./locale/jv.js": () => import("./jv-682e5b4f.js"), "./locale/ka.js": () => import("./ka-2cd3dec3.js"), "./locale/kk.js": () => import("./kk-857eab76.js"), "./locale/km.js": () => import("./km-f6c10ca1.js"), "./locale/kn.js": () => import("./kn-6bed060c.js"), "./locale/ko.js": () => import("./ko-40c1d0e8.js"), "./locale/ku.js": () => import("./ku-4161f4ac.js"), "./locale/ky.js": () => import("./ky-b2d0a4f3.js"), "./locale/lb.js": () => import("./lb-5221aee8.js"), "./locale/lo.js": () => import("./lo-ddb26fe2.js"), "./locale/lt.js": () => import("./lt-40d21db3.js"), "./locale/lv.js": () => import("./lv-9ab5406a.js"), "./locale/me.js": () => import("./me-093f039d.js"), "./locale/mi.js": () => import("./mi-8d797083.js"), "./locale/mk.js": () => import("./mk-4eecc6f0.js"), "./locale/ml.js": () => import("./ml-a598c7ad.js"), "./locale/mn.js": () => import("./mn-8df1daeb.js"), "./locale/mr.js": () => import("./mr-53cc7742.js"), "./locale/ms-my.js": () => import("./ms-my-42018a24.js"), "./locale/ms.js": () => import("./ms-06791820.js"), "./locale/mt.js": () => import("./mt-ce35ed50.js"), "./locale/my.js": () => import("./my-2071f13b.js"), "./locale/nb.js": () => import("./nb-4dedf9c9.js"), "./locale/ne.js": () => import("./ne-946e0be5.js"), "./locale/nl-be.js": () => import("./nl-be-5d2ff967.js"), "./locale/nl.js": () => import("./nl-afb8828a.js"), "./locale/nn.js": () => import("./nn-4c9ebe0c.js"), "./locale/oc-lnc.js": () => import("./oc-lnc-7d08aa6c.js"), "./locale/pa-in.js": () => import("./pa-in-58b8de56.js"), "./locale/pl.js": () => import("./pl-68a7bccb.js"), "./locale/pt-br.js": () => import("./pt-br-eca39666.js"), "./locale/pt.js": () => import("./pt-57f7db62.js"), "./locale/rn.js": () => import("./rn-fa2a2b61.js"), "./locale/ro.js": () => import("./ro-9638c4d7.js"), "./locale/ru.js": () => import("./ru-a4e25bd3.js"), "./locale/rw.js": () => import("./rw-fa3789ce.js"), "./locale/sd.js": () => import("./sd-e4b49bd5.js"), "./locale/se.js": () => import("./se-5a604ec4.js"), "./locale/si.js": () => import("./si-4c481876.js"), "./locale/sk.js": () => import("./sk-0762be54.js"), "./locale/sl.js": () => import("./sl-062316c7.js"), "./locale/sq.js": () => import("./sq-19048dd4.js"), "./locale/sr-cyrl.js": () => import("./sr-cyrl-00d6e041.js"), "./locale/sr.js": () => import("./sr-80dddaff.js"), "./locale/ss.js": () => import("./ss-9305ec5e.js"), "./locale/sv-fi.js": () => import("./sv-fi-2cac8b3b.js"), "./locale/sv.js": () => import("./sv-39b64e83.js"), "./locale/sw.js": () => import("./sw-ad8ef50a.js"), "./locale/ta.js": () => import("./ta-ebdedf92.js"), "./locale/te.js": () => import("./te-06978df6.js"), "./locale/tet.js": () => import("./tet-33f3098b.js"), "./locale/tg.js": () => import("./tg-86ff25ac.js"), "./locale/th.js": () => import("./th-56cc0624.js"), "./locale/tk.js": () => import("./tk-6f8f1466.js"), "./locale/tl-ph.js": () => import("./tl-ph-6a3ce9cd.js"), "./locale/tlh.js": () => import("./tlh-a868b818.js"), "./locale/tr.js": () => import("./tr-f9a44fbe.js"), "./locale/tzl.js": () => import("./tzl-cbe9470f.js"), "./locale/tzm-latn.js": () => import("./tzm-latn-5e7eb365.js"), "./locale/tzm.js": () => import("./tzm-ca14ea81.js"), "./locale/ug-cn.js": () => import("./ug-cn-63dc2a7e.js"), "./locale/uk.js": () => import("./uk-b1b489f5.js"), "./locale/ur.js": () => import("./ur-39308e30.js"), "./locale/uz-latn.js": () => import("./uz-latn-9cf625a1.js"), "./locale/uz.js": () => import("./uz-f726d902.js"), "./locale/vi.js": () => import("./vi-9655cafa.js"), "./locale/x-pseudo.js": () => import("./x-pseudo-0abd43c6.js"), "./locale/yo.js": () => import("./yo-c88b62f9.js"), "./locale/zh-cn.js": () => import("./zh-cn-b68fa3dd.js"), "./locale/zh-hk.js": () => import("./zh-hk-a1b726de.js"), "./locale/zh-tw.js": () => import("./zh-tw-a7b48b19.js"), "./locale/zh.js": () => import("./zh-f3aa9226.js") })).map(
    ([t, o]) => {
      var a;
      ...
      m.value ? (z(), Z("ol", so, [
        (z(!0), Z(we, null, We(m.value, (g, O) => (z(), Z("li", { key: O }, [
          A("a", {
            ...
            onClick: Me((V) => se(l)(g, p.close), ["prevent"]),
        ...
        A("li", null, [
          A("a", {
            href: "#",
            class: "vtd-shortcuts block text-sm lg:text-xs px-2 py-2 sm:leading-4 whitespace-nowrap font-medium rounded text-vtd-primary-600 hover:text-vtd-primary-700 transition-colors hover:bg-vtd-secondary-100 focus:bg-vtd-secondary-100 focus:text-vtd-primary-600 dark:hover:bg-vtd-secondary-700 dark:hover:text-vtd-primary-300 dark:text-vtd-primary-400 dark:focus:bg-vtd-secondary-700 dark:focus:text-vtd-primary-300",
            onClick: w[0] || (w[0] = Me((g) => se(a)(p.close), ["prevent"]))
          }, ae(o.i18n.today), 1)
        ]),
        A("li", null, [
          A("a", {
            href: "#",
            class: "vtd-shortcuts block text-sm lg:text-xs px-2 py-2 sm:leading-4 whitespace-nowrap font-medium rounded text-vtd-primary-600 hover:text-vtd-primary-700 transition-colors hover:bg-vtd-secondary-100 focus:bg-vtd-secondary-100 focus:text-vtd-primary-600 dark:hover:bg-vtd-secondary-700 dark:hover:text-vtd-primary-300 dark:text-vtd-primary-400 dark:focus:bg-vtd-secondary-700 dark:focus:text-vtd-primary-300",
            onClick: w[1] || (w[1] = Me((g) => se(e)(p.close), ["prevent"]))
        ...
        A("li", null, [
          A("a", {
            href: "#",
            class: "vtd-shortcuts block text-sm lg:text-xs px-2 py-2 sm:leading-4 whitespace-nowrap font-medium rounded text-vtd-primary-600 hover:text-vtd-primary-700 transition-colors hover:bg-vtd-secondary-100 focus:bg-vtd-secondary-100 focus:text-vtd-primary-600 dark:hover:bg-vtd-secondary-700 dark:hover:text-vtd-primary-300 dark:text-vtd-primary-400 dark:focus:bg-vtd-secondary-700 dark:focus:text-vtd-primary-300",
            onClick: w[2] || (w[2] = Me((g) => se(s)(7, p.close), ["prevent"]))
          }, ae(o.i18n.past(7)), 1)
        ]),
        A("li", null, [
          A("a", {
            href: "#",
            class: "vtd-shortcuts block text-sm lg:text-xs px-2 py-2 sm:leading-4 whitespace-nowrap font-medium rounded text-vtd-primary-600 hover:text-vtd-primary-700 transition-colors hover:bg-vtd-secondary-100 focus:bg-vtd-secondary-100 focus:text-vtd-primary-600 dark:hover:bg-vtd-secondary-700 dark:hover:text-vtd-primary-300 dark:text-vtd-primary-400 dark:focus:bg-vtd-secondary-700 dark:focus:text-vtd-primary-300",
            onClick: w[3] || (w[3] = Me((g) => se(s)(30, p.close), ["prevent"]))
          }, ae(o.i18n.past(30)), 1)
        ]),
        A("li", null, [
          A("a", {
            href: "#",
            class: "vtd-shortcuts block text-sm lg:text-xs px-2 py-2 sm:leading-4 whitespace-nowrap font-medium rounded text-vtd-primary-600 hover:text-vtd-primary-700 transition-colors hover:bg-vtd-secondary-100 focus:bg-vtd-secondary-100 focus:text-vtd-primary-600 dark:hover:bg-vtd-secondary-700 dark:hover:text-vtd-primary-300 dark:text-vtd-primary-400 dark:focus:bg-vtd-secondary-700 dark:focus:text-vtd-primary-300",
            onClick: w[4] || (w[4] = Me((g) => se(n)(p.close), ["prevent"]))
        ...
        A("li", null, [
          A("a", {
            href: "#",
            class: "vtd-shortcuts block text-sm lg:text-xs px-2 py-2 sm:leading-4 whitespace-nowrap font-medium rounded text-vtd-primary-600 hover:text-vtd-primary-700 transition-colors hover:bg-vtd-secondary-100 focus:bg-vtd-secondary-100 focus:text-vtd-primary-600 dark:hover:bg-vtd-secondary-700 dark:hover:text-vtd-primary-300 dark:text-vtd-primary-400 dark:focus:bg-vtd-secondary-700 dark:focus:text-vtd-primary-300",
            onClick: w[5] || (w[5] = Me((g) => se(h)(p.close), ["prevent"]))
      ...
      ee(Xt, {
        ...
        default: Fe(() => [
          (z(!0), Z(we, null, We(h.calendar.date(), (m, p) => (z(), Z(we, { key: p }, [
            ...
            A("div", {
              class: Te(["relative", { "vtd-tooltip": h.asRange && m.duration() }]),
              ...
              ee(mt, {
                ...
                default: Fe(() => [
                  se(a)(m) || m.hovered() ? (z(), Z("span", {
                    key: 0,
                    class: Te(["absolute bg-vtd-primary-100 bg-opacity-60 dark:bg-vtd-secondary-700 dark:bg-opacity-50", se(e)(m)])
                  }, null, 2)) : ye("", !0)
                ]),
                _: 2
              }, 1024),
...
const Mo = ["disabled", "placeholder", "onKeyup"], So = { class: "absolute inset-y-0 right-0 inline-flex items-center rounded-md overflow-hidden" }, Do = ["disabled"], _o = {
  class: "w-5 h-5",
  fill: "none",
  stroke: "currentColor",
  viewBox: "0 0 24 24",
  ...
  setup(t, { expose: o, emit: a }) {
    ...
    const O = J(null), V = J(null), B = J(null), x = J(""), P = J(null), k = J(""), S = J([]), y = J([]), N = J(null), L = J(null), i = vt({
      ...
      const { previous: v, next: c, year: f } = se(r);
      return {
        previous: {
          ...
          onNext: () => {
            r.value.previous = v.add(1, "month"), v.diff(c, "month") === -1 && (r.value.next = c.add(1, "month")), a("clickNext", r.value.previous);
          },
          onPreviousYear: () => {
        ...
        next: {
          date: () => m(c).concat(s(c)).concat(l(c)).map((u) => (Object.assign(u, {
            today: u.isToday(),
          ...
          onPrevious: () => {
            r.value.next = c.subtract(1, "month"), c.diff(v, "month") === 1 && (r.value.previous = v.subtract(1, "month")), a("clickRightPrev", r.value.next);
          },
          onNext: () => {
            r.value.next = c.add(1, "month"), a("clickRightNext", r.value.next);
          },
          onPreviousYear: () => {
          ...
          setMonth: (u) => {
            r.value.next = c.month(u), i.next.month = !i.next.month, i.next.year = !1, i.next.calendar = !i.next.month, a("selectRightMonth", r.value.next), Ie(() => {
          ...
          setYear: (u) => {
            r.value.next = c.year(u), i.next.year = !i.next.year, i.next.month = !1, i.next.calendar = !i.next.year, a("selectRightYear", r.value.next), Ie(() => {
              (r.value.previous.isSame(r.value.next, "month") || r.value.previous.isAfter(r.value.next)) && (r.value.previous = r.value.next.subtract(
                1,
                "month"
    ...
    function Y() {
      if (k.value = "", Array.isArray(e.modelValue))
        ...
        const v = {}, [c, f] = Object.keys(e.modelValue);
        v[c] = "", v[f] = "", a("update:modelValue", v);
      } else
        a("update:modelValue", "");
    ...
    function D() {
      if ($()) {
        const [v, c] = k.value.split(e.separator), [f, u] = [
          d(v, e.formatter.date, !0),
          d(c, e.formatter.date, !0)
        ];
        if (f.isValid() && u.isValid())
          if (E(f), E(u), Array.isArray(e.modelValue))
            a("update:modelValue", [v, c]);
          else if (typeof e.modelValue == "object") {
            const j = {}, [F, W] = Object.keys(e.modelValue);
            j[F] = v, j[W] = c, a("update:modelValue", j);
          } else
            a(
              "update:modelValue",
              p(
        ...
        if (v.isValid())
          if (E(v), Array.isArray(e.modelValue))
            ...
            const c = {}, [f] = Object.keys(e.modelValue);
      ...
      if ($())
        if (N.value)
          if (L.value = v, e.autoApply) {
            ...
            const [f, u] = k.value.split(e.separator);
            if (Array.isArray(e.modelValue))
              a("update:modelValue", [
                d(f, e.formatter.date, !0).format(e.formatter.date),
                d(u, e.formatter.date, !0).format(e.formatter.date)
              ]);
            else if (typeof e.modelValue == "object") {
              const j = {}, [F, W] = Object.keys(e.modelValue);
              j[F] = f, j[W] = u, a("update:modelValue", j);
            } else
              a(
                "update:modelValue",
                p(
            ...
            c && c(), y.value = [], d(f, e.formatter.date, !0).isSame(
              d(u, e.formatter.date, !0),
              "month"
            ) || (r.value.previous = d(f, e.formatter.date, !0), r.value.next = d(u, e.formatter.date, !0)), M();
          } else {
            N.value.isAfter(v, "month") ? y.value = [v, N.value] : y.value = [N.value, v];
            const [f, u] = y.value;
            f.isSame(u, "month") || (r.value.previous = f, r.value.next = u), M();
          }
        else
        ...
        if (k.value = w(v, e), Array.isArray(e.modelValue))
          ...
          const f = {}, [u] = Object.keys(e.modelValue);
    ...
    function R(v) {
      ...
      if ($()) {
        ...
        k.value = c;
      } else if (k.value = c.format(e.formatter.date), Array.isArray(e.modelValue))
        a("update:modelValue", [k.value]);
      else if (typeof e.modelValue == "object") {
        const f = {}, [u] = Object.keys(e.modelValue);
        f[u] = k.value, a("update:modelValue", f);
    ...
    function Q(v) {
      ...
      if (S.value.length > 1) {
        const [u, j] = S.value;
        c = d(u, e.formatter.date, !0), f = d(j, e.formatter.date, !0);
      } else if (Array.isArray(e.modelValue))
        if (e.autoApply) {
          const [u, j] = e.modelValue;
          c = u && d(u, e.formatter.date, !0), f = j && d(j, e.formatter.date, !0);
        } else {
          const [u, j] = y.value;
          c = d(u, e.formatter.date, !0), f = d(j, e.formatter.date, !0);
        }
    ...
    function te(v) {
      const { today: c, active: f, off: u, disabled: j } = v;
      let F, W, de;
      if ($())
        if (Array.isArray(e.modelValue))
          if (P.value) {
    ...
    function re(v) {
      ...
      if (Array.isArray(e.modelValue))
        if (S.value.length > 1) {
          const [j, F] = S.value;
          f = j && d(j, e.formatter.date, !0), u = F && d(F, e.formatter.date, !0);
        } else if (e.autoApply) {
      ...
      return f && u && (v.isSame(f, "date") ? (u.isBefore(f) && (c += " rounded-r-full inset-0"), f.isBefore(u) && (c += " rounded-l-full inset-0")) : v.isSame(u, "date") ? (u.isBefore(f) && (c += " rounded-l-full inset-0"), f.isBefore(u) && (c += " rounded-r-full inset-0")) : c += " inset-0"), c;
    }
    function ie(v, c) {
      r.value.previous = d(v, e.formatter.date, !0), r.value.next = d(c, e.formatter.date, !0), (d.duration(r.value.next.diff(r.value.previous)).get("months") === 2 || d.duration(r.value.next.diff(r.value.previous)).get("months") === 1 && d.duration(r.value.next.diff(r.value.previous)).get("days") === 7) && (r.value.next = r.value.next.subtract(1, "month")), (r.value.next.isSame(r.value.previous, "month") || r.value.next.isBefore(r.value.previous)) && (r.value.next = r.value.previous.add(1, "month"));
    }
    function ce(v, c) {
      if ($())
        if (e.autoApply) {
          if (Array.isArray(e.modelValue))
            ...
            const f = {}, [u, j] = Object.keys(e.modelValue);
            f[u] = v, f[j] = c, a("update:modelValue", f);
          } else
            a(
              "update:modelValue",
              p(
    ...
    function be(v) {
      const c = d().format(e.formatter.date), f = d().format(e.formatter.date);
      ce(c, f), v && v();
    }
    function ge(v) {
      const c = d().subtract(1, "day").format(e.formatter.date), f = d().subtract(1, "day").format(e.formatter.date);
      ce(c, f), v && v();
    }
    function he(v, c) {
      const f = d().subtract(v - 1, "day").format(e.formatter.date), u = d().format(e.formatter.date);
      ce(f, u), c && c();
    }
    function oe(v) {
      const c = d().date(1).format(e.formatter.date), f = d().date(d().daysInMonth()).format(e.formatter.date);
      ce(c, f), v && v();
    }
    function fe(v) {
      const c = d().date(1).subtract(1, "month").format(e.formatter.date), f = d().date(0).format(e.formatter.date);
      ce(c, f), v && v();
    }
    function xe(v, c) {
      const [f, u] = v.atClick(), j = d(f).format(e.formatter.date), F = d(u).format(e.formatter.date);
      ce(j, F), c && c();
    }
    Qt(
      () => y.value,
      ...
      Ie(async () => {
        ...
        if ($()) {
          if (Array.isArray(c)) {
            if (c.length > 0) {
              const [F, W] = c;
              f = d(F, e.formatter.date, !0), u = d(W, e.formatter.date, !0);
            }
            ...
            if (c) {
              ...
              f = F && d(F, e.formatter.date, !0), u = W && d(W, e.formatter.date, !0);
            }
          } else if (c) {
            const [F, W] = c.split(e.separator);
            f = d(F, e.formatter.date, !0), u = d(W, e.formatter.date, !0);
          }
          f && u ? (k.value = p(
            {
            ...
            e
          ), u.isBefore(f, "month") ? (r.value.previous = u, r.value.next = f, r.value.year.previous = u.year(), r.value.year.next = f.year()) : u.isSame(f, "month") ? (r.value.previous = f, r.value.next = u.add(1, "month"), r.value.year.previous = f.year(), r.value.year.next = f.add(1, "year").year()) : (r.value.previous = f, r.value.next = u, r.value.year.previous = f.year(), r.value.year.next = u.year()), e.autoApply || (y.value = [f, u])) : (r.value.previous = d(e.startFrom), r.value.next = d(e.startFrom).add(1, "month"), r.value.year.previous = r.value.previous.year(), r.value.year.next = r.value.next.year());
        } else {
          if (Array.isArray(c)) {
            if (c.length > 0) {
              const [F] = c;
              f = d(F, e.formatter.date, !0);
            }
          } else if (typeof c == "object") {
            if (c) {
            ...
            const [F] = c.split(e.separator);
            f = d(F, e.formatter.date, !0);
          }
          f && f.isValid() ? (k.value = w(f, e), r.value.previous = f, r.value.next = f.add(1, "month"), r.value.year.previous = f.year(), r.value.year.next = f.add(1, "year").year(), e.autoApply || (y.value = [f])) : (r.value.previous = d(e.startFrom), r.value.next = d(e.startFrom).add(1, "month"), r.value.year.previous = r.value.previous.year(), r.value.year.next = r.value.next.year());
        }
    ...
    return ne(Ft, Q), ne(Bt, re), ne(Nt, te), ne(Rt, G), ne(It, be), ne(Ht, ge), ne(Ut, he), ne(zt, oe), ne(Wt, fe), ne(Kt, xe), (v, c) => e.noInput ? C.value ? (z(), Z("div", Go, [
      A("div", Zo, [
        A("div", qo, [
          e.shortcuts ? (z(), He(pt, {
            key: 0,
