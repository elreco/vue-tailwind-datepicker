...
interface DatepickerProps {
    ...
    modelValue: [Date, Date] | { start: Date; end: Date } | string;
...
declare type VueTailwindDatePicker =  DefineComponent<DatepickerProps, TypedDatepickerData, unknown, ComputedOptions, MethodOptions, ComponentOptionsMixin, ComponentOptionsMixin, TypedDatepickerEmits>;
