...
const VueTailwindDatepickerRef = ref(null)
    ...
    <slot :value="pickerValue" :placeholder="givenPlaceholder" :clear="clearPicker">
      <label class="relative block">
        <input
          ...
          @keyup="keyUp"
        />
        <span class="absolute inset-y-0 right-0 inline-flex items-center rounded-md overflow-hidden">
          <button
            type="button"
          ...
          >
            <div class="flex flex-wrap lg:flex-nowrap">
              ...
              <div class="relative flex flex-wrap sm:flex-nowrap p-1">
                <div v-if="asRange() && !props.asSingle" class="hidden absolute inset-0 sm:flex justify-center items-center">
                ...
                <div v-if="asRange() && !props.asSingle" class="relative w-full sm:w-80 overflow-hidden mt-3 sm:mt-0 sm:ml-2">
