...
<template>
  <div
    ...
    class="tw-relative tw-w-full tw-border-t tw-border-b-0 sm:tw-border-t-0 sm:tw-border-b lg:tw-border-b-0 lg:tw-border-r tw-border-black/[.1] tw-order-last sm:tw-order-none dark:tw-border-vtd-secondary-700/[1] sm:tw-mt-1 lg:tw-mr-1 sm:tw-mb-1 lg:tw-mb-0 sm:tw-mx-1 lg:mx-0"
  >
    <ol
      v-if="withShortcut()"
